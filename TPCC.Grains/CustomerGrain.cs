...
namespace TPCC.Grains
{
    ...
    {
        ITPCCManager tpccManager;

        public CustomerGrain(IPersistSingletonGroup persistSingletonGroup, ITPCCManager tpccManager) : base(persistSingletonGroup, "TPCC.Grains.CustomerGrain")
        {
        ...
        public async Task<TransactionResult> NewOrder(MyTransactionContext context, object funcInput)
        {
            var res = new TransactionResult();
            try
            {
                ...
                Dictionary<int, float> itemPrices;
                {
                    ...
                    var itemGrainID = tpccManager.GetItemGrain(myState.W_ID);
                ...
                long O_ID;
                {
                    var tasks = new List<Task<TransactionResult>>();
                    {
                        ...
                        var warehouseGrainID = tpccManager.GetWarehouseGrain(myState.W_ID);
                    ...
                    }
                    {
                        ...
                        var districtGrainID = tpccManager.GetDistrictGrain(myState.W_ID, myState.D_ID);
                ...
                var items_dist_info = new Dictionary<int, string>();
                {
                    ...
                    foreach (var item in ItemsToBuy)                                  // <I_ID, <supply W_ID, quantity>>
                    {
                        ...
                        if (I_ID != -1)
                        {
                            ...
                            var stockGrain = tpccManager.GetStockGrain(supply_W_ID, I_ID);
                ...
                {
                    var orderGrainID = tpccManager.GetOrderGrain(myState.W_ID, myState.D_ID, C_ID);
