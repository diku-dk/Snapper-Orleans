...
{
    public class NTCustomerGrain : Orleans.Grain, INTCustomerGrain
    {
            ...
            try
            {
                ...
                long O_ID;
                {
                    var tasks = new List<Task<TransactionResult>>();
                    {
                        ...
                        var warehouseGrain = GrainFactory.GetGrain<INTWarehouseGrain>(warehouseGrainID);
                    ...
                    }
                    {
                        ...
                        var districtGrain = GrainFactory.GetGrain<INTDistrictGrain>(districtGrainID);
                ...
                var items_dist_info = new Dictionary<int, string>();
                {
                    ...
                    foreach (var grain in stockToUpdate)
                    {
                        ...
                        var stockGrain = GrainFactory.GetGrain<INTStockGrain>(grain.Key);
                ...
                // STEP 4: insert records to OrderGrains
                {
                    ...
                    var orderGrain = GrainFactory.GetGrain<INTOrderGrain>(orderGrainID);
