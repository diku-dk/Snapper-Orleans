...
namespace Concurrency.Implementation.TransactionExecution
{
    ...
    public abstract class TransactionExecutionGrain<TState> : Grain, ITransactionExecutionGrain where TState : ICloneable, new()
    {
        ...
        private ILocalCoordGrain myCoord;
        ...
        private Dictionary<int, ILocalCoordGrain> coordList;  // <coordID, coord>
        ...
        public async override Task OnActivateAsync()
        {
            ...
            coordID = myID % Constants.numLocalCoordPerSilo;
            myCoord = GrainFactory.GetGrain<ILocalCoordGrain>(coordID);
            ...
            switch (Constants.loggingType)
            {
                ...
                case LoggingType.LOGGER:
                    var loggerID = Helper.MapGrainIDToLoggerID(myID, Constants.numLoggerPerSilo);
            ...
            coordList = new Dictionary<int, ILocalCoordGrain>();
        ...
        public async Task<FunctionResult> Execute(FunctionCall call, TransactionContext context)
        {
            ...
            else
            {
                ...
                if (myScheduler.ackComplete(bid, tid, myTurnIndex))
                {
                    ...
                    ILocalCoordGrain coordinator;
                    if (coordList.ContainsKey(coordID) == false)
                    {
                        coordinator = GrainFactory.GetGrain<ILocalCoordGrain>(coordID);
